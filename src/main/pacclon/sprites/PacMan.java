...
public class PacMan implements ISpritesMethods {
	...
	// [0]direccionX, [1]direccionY, [2][3]Max-Boca, [4][5]=Min-Boca...
	// [0] y [1] =>( 1,0 = ri | -1,0 = le | 0,-1 up | 0,1 = do )
	...
	public void dibuja(Graphics g, int[][] matriz, Settings sett) {
		...
		if (sett.estado.isPacmanDying()) {
			// Si PacmanDying... hacer secuencia dying y *** return ***
			PacmanDyingClass.dyingAnima(g, sett, rgb, this.x, this.y, this.contadorAnima);
			return;
		}
	...
	public void activarMiliSecFantasmasAzules(Settings sett) {
